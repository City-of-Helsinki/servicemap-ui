...
const translations = {
  ...
  'unit.route.extra.hsl': '(New tab. The HSL Journey Planner is not an accessible service)',
  'unit.route.extra.digitransit': '(New tab. The Matka.fi Journey Planner is not an accessible service)',
