...
const translations = {
  ...
  'area.statisticalDistrict.label': '{count} henkilöä, {percent}% väestöstä',
  'area.statisticalDistrict.label.total': '{count} henkilöä',
  'area.statisticalDistrict.label.people': '{count} henkilöä',
  'area.statisticalDistrict.label.percent': '{percent}% väestöstä',
  ...
  'area.statisticalDistrict.title': 'Valitse väestötieto',
