      ...
      <ul>
        ...
        <li>
          <Link target="_blank" href="https://github.com/City-of-Helsinki/smbackend/">
            <StyledLink variant="body2">Palvelinsovelluksen lähdekoodi</StyledLink>
          </Link>
        </li>
      </ul>
      <StyledText variant="body2">
  ...
  const renderEnglishInfo = () => (
    <StyledTextContainer>
      ...
      <ul>
        <li>
          <Link target="_blank" href="https://github.com/City-of-Helsinki/servicemap-ui/">
            <StyledLink variant="body2">Source code for the application</StyledLink>
          </Link>
        </li>
        <li>
          <Link target="_blank" href="https://github.com/City-of-Helsinki/smbackend/">
            <StyledLink variant="body2">Source code for the server application</StyledLink>
          </Link>
        </li>
      </ul>
      <StyledText variant="body2">
  ...
  const renderSwedishInfo = () => (
    <StyledTextContainer>
      ...
      <ul>
        ...
        <li>
          <Link target="_blank" href="https://github.com/City-of-Helsinki/smbackend/">
            <StyledLink variant="body2">Serverapplikationens källkod</StyledLink>
          </Link>
        </li>
      </ul>
      <StyledText variant="body2">
      ...
      <StyledPageContainer>
        ...
        <NoSsr>
          {config.version || config.commit
            ? <StyledText align="left" aria-hidden="true">{versionText}</StyledText>
            : null}
        </NoSsr>
      </StyledPageContainer>
    </div>
