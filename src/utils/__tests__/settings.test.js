...
describe('SettingsUtility.isValidAccessibilitySenseImpairment', () => {
  it('', () => {
    expect(SettingsUtility.isValidAccessibilitySenseImpairment('colorblind')).toBe(true);
    expect(SettingsUtility.isValidAccessibilitySenseImpairment('hearingAid')).toBe(true);
...
describe('SettingsUtility.mapValidAccessibilitySenseImpairmentValueToKey', () => {
  it('', () => {
    expect(SettingsUtility.mapValidAccessibilitySenseImpairmentValueToKey('colorblind')).toBe(undefined);
    expect(SettingsUtility.mapValidAccessibilitySenseImpairmentValueToKey('hearingAid')).toBe(undefined);
...
describe('SettingsUtility.isValidMobilitySetting', () => {
  it('', () => {
    ...
    expect(SettingsUtility.isValidMobilitySetting('reduced_mobility')).toBe(true);
...
describe('SettingsUtility.parseShortcomingSettings', () => {
  it('', () => {
    ...
    expect(SettingsUtility.parseShortcomingSettings({ mobility: 'none' })).toEqual([]);
